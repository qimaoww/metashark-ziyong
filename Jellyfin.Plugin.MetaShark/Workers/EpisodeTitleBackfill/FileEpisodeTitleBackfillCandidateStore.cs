// <copyright file="FileEpisodeTitleBackfillCandidateStore.cs" company="PlaceholderCompany">
...
namespace Jellyfin.Plugin.MetaShark.Workers.EpisodeTitleBackfill
{
    ...
    public sealed class FileEpisodeTitleBackfillCandidateStore : IEpisodeTitleBackfillCandidateStore
    {
        ...
        public FileEpisodeTitleBackfillCandidateStore(string stateFilePath, ILoggerFactory loggerFactory)
        {
            ...
            this.logger = loggerFactory.CreateLogger<FileEpisodeTitleBackfillCandidateStore>();
        }
        ...
        private void EnsureLoaded()
        {
            ...
            this.candidatesByItemId = JsonStateFile.LoadOrReset<EpisodeTitleBackfillCandidate>(
                this.stateFilePath,
