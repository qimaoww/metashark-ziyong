// <copyright file="EpisodeOverviewCleanupDeferredRetryWorker.cs" company="PlaceholderCompany">
...
namespace Jellyfin.Plugin.MetaShark.Workers
{
    ...
    public sealed class EpisodeOverviewCleanupDeferredRetryWorker : IHostedService, IDisposable
    {
        ...
        private readonly ILogger<EpisodeOverviewCleanupDeferredRetryWorker> logger;
        private CancellationTokenSource? executionCancellationTokenSource;
        private Task? executionTask;

        public EpisodeOverviewCleanupDeferredRetryWorker(
            ...
            ILogger<EpisodeOverviewCleanupDeferredRetryWorker> logger)
        {
...
#pragma warning restore CA1031
        ...
        private async Task ProcessCandidateAsync(EpisodeOverviewCleanupCandidate candidate, DateTimeOffset nowUtc, CancellationToken cancellationToken)
        {
            ...
            try
            {
                await this.postProcessService.TryApplyAsync(
                    ...
                    IEpisodeOverviewCleanupPostProcessService.DeferredRetryTrigger,
