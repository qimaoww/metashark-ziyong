...
namespace Jellyfin.Plugin.MetaShark.Workers
{
    ...
    public sealed class MovieSeriesPeopleRefreshStateItemUpdatedWorker : IHostedService, IDisposable
    {
        ...
        private async Task ProcessItemUpdatedAsync(ItemChangeEventArgs e, CancellationToken cancellationToken)
        {
            ...
            try
            {
                await this.postProcessService.TryApplyAsync(e, MovieSeriesPeopleRefreshStatePostProcessService.ItemUpdatedTrigger, cancellationToken).ConfigureAwait(false);
            }
