...
namespace Jellyfin.Plugin.MetaShark.Workers
{
    ...
    public sealed class EpisodeOverviewCleanupItemUpdatedWorker : IHostedService, IDisposable
    {
        ...
        private async Task ProcessItemUpdatedAsync(ItemChangeEventArgs e, CancellationToken cancellationToken)
        {
            ...
            try
            {
                await this.postProcessService.TryApplyAsync(e, IEpisodeOverviewCleanupPostProcessService.ItemUpdatedTrigger, cancellationToken).ConfigureAwait(false);
            }
