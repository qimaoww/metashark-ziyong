...
构建目标框架为 `net10.0`，仅适用于 Jellyfin 12.1 及以上的服务端；Jellyfin 10.x / 11.x 不再兼容，需要旧版本请使用 `v3.1.0` 的构建产物。Jellyfin 12.0 用户请停留在 `v3.2.3`（manifest 的 `targetAbi` 从 3.2.4 起为 `12.1.0.0`）。
